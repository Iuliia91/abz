...
function App() {
  ...
  return (
    <>
      ...
      <div className="block_post  content_center ">
        ...
        <form id="form" onSubmit={handleSubmit}>
          <section className="block_post--form">
            <div class="input-container ic1">
              ...
              <label
                htmlFor="firstname"
                className={`placeholder p1 ${errors.name ? 'error_cut' : ''}`}
              >
                Your name
              </label>
              {errors.name && (
            ...
            <div className="input-container ic1">
              ...
              <label
                htmlFor="firstname"
                className={`placeholder p1 ${errors.email ? 'error_cut' : ''}`}
              >
                Email
              </label>
              {errors.email && (
            ...
            <div className="input-container ic1">
              ...
              <label
                htmlFor="firstname"
                className={`placeholder p1 ${errors.phone ? 'error_cut' : ''}`}
              >
                Phone
              </label>
              {!errors.phone && (
